<div>
	...
	<table class="admin">
		...
		<tr>
			...
			<td>
			<?php echo html::anchor('admin/plugins/info/'.$plugin->dir,
			...
			<?php echo html::anchor('admin/plugins/enable/'.$plugin->dir,
